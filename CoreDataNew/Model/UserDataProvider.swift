...
class UserDataProvider {
    ...
    func generateFakeUsers() -> [User] {
        let user1 = User(name: "Jack Jack Jack Jack Jack Jack Jack Jack Jack vjjk", surname: "Hoggarth", avatar: UIImage(named: "placeholder1")!, postsCount: 300, commentsCount: 600, likesCount: 1000)
