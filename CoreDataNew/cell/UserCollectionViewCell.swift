...
class UserCollectionViewCell: UICollectionViewCell, CellInterface {
    ...
    func bind(_ user: User) {
        avatarImageView.image = LetterImageGenerator.imageWith(name: user.name) //user.avatar
        nameListLabel.text = user.name //user.name.localized + " " + user.surname.localized
